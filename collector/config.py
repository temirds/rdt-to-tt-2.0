...
def load_collector_settings(path: Path = DEFAULT_CONFIG_PATH) -> LoadedCollectorSettings:
    ...
    config = CollectorConfig(
        ...
        max_comment_length=int(collector_raw.get("max_comment_length", CollectorConfig.max_comment_length)),
    ...
    query = CollectorQuery(
        ...
        max_question_length=int(reddit_raw.get("max_question_length", CollectorQuery.max_question_length)),
